...
return (
  <div id='container' className='fixed bg-gray-500 inset-0 bg-opacity-60 backdrop-blur-sm flex md:justify-center '>
    <div className='relative top-12 left-0 md:w-[32rem] p-2 h-[11rem] '>
        <p className='font-bold justify-center grid text-white text-lg'>Enter the Details you want to update here</p>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className=" absolute w-7 h-7 m-2 -top-5 md:top-1 cursor-pointer" onClick={close}>
